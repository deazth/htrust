...
import { 
  ...
  useColorMode, Switch, HStack, StatusBar, Spacer
 } from 'native-base';
...
export const PageTitle = ({children, ...props}) => {
  return (
    <VStack space={2} alignItems="center">
      <Text m={2} bold color={ useColorModeValue(unifi_c4, unifi_c1)} {...props} >{children}</Text>
    </VStack>
  );
}
...
export const ItemCards = ({title, text1, text2, showBtn=true, btnlabel = '', btnAction = null, btnIcon = '', itemid = 0, btnSize=8}) => {
    ...
    {/* <Box p={2} m={2} bg={cc_inner_bg} rounded="10px" flexDirection='row'> */}
      ...
      {showBtn && (
        ...
        // <View flex={1}>
          ...
          >
            <Center flex={1}>
              <Icon color={main_text} as={FontAwesome5} name={btnIcon} size={btnSize} />
...
export const DiaryItemCards = ({title, text1, text2, editAction, deleteAction, itemid}) => {
